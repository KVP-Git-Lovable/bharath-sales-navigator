...
/**
 * Fetches all three config levels and returns a resolver function.
 * Priority: User > Manager/Team > Global
 */
 ...
 * Priority: user_expense_config > team_expense_config (by manager_id) > global
 */
