...
const typeConfig: Record<TaskType, { label: string; emoji: string; className: string }> = {
  epic:      { label: "Epic",      emoji: "⚡", className: "bg-violet-100 text-violet-700 dark:bg-violet-900/30 dark:text-violet-400" },
  story:     { label: "Story",     emoji: "📖", className: "bg-blue-100 text-blue-700 dark:bg-blue-900/30 dark:text-blue-400" },
