    ...
    Tables: {
      ...
      companies: {
        Row: {
          ...
          email: string | null
          eway_threshold_value: number | null
          gstin: string | null
      ...
      fy_target_config: {
        Row: {
          ...
          enable_retailer_activation: boolean | null
